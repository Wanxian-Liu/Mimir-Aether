...
Usage:
    ...
    mimir honcho migrate                  # Step-by-step migration guide: OpenClaw native → Hermes + Honcho
...
""",
    ...
    mcp_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "'mimir mcp serve' to expose Hermes conversations over MCP."
        ),
    )
...
""",
    ...
    # e.g. ``mimir -c Pokemon Agent Dev`` → ``mimir -c 'Pokemon Agent Dev'``
