"""
VoiceMixin — Voice/TTS command handlers and voice mode persistence.
...
class VoiceMixin:
    """Voice mode persistence and voice command handlers.

    Designed to be mixed into GatewayRunner. All methods assume the
    host class provides: self._voice_mode, self.adapters,
    self._get_guild_id(), self._is_user_authorized().
    """
    ...
    def _VOICE_MODE_PATH(self) -> Path:
        ...
        return get_hermes_home() / "gateway_voice_mode.json"
