"""
Email platform adapter for the MimirAether gateway.

Allows users to interact with MimirAether by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "MimirAether Agent")
        ...
        msg_id = f"<mimiraether-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
