"""
DM Pairing System (MimirAether port)
...
from mimiraether_constants import get_hermes_home
...
def _get_pairing_dir() -> Path:
    """Return the pairing directory, creating it if needed."""
    d = get_hermes_home() / "platforms" / "pairing"
    d.mkdir(parents=True, exist_ok=True)
    return d


PAIRING_DIR = _get_pairing_dir()
