"""Models.dev registry integration — provider-aware model metadata.
...
Data resolution order:
  ...
  2. Disk cache (~/projects/MimirAether/models_dev_cache.json)
  3. Network fetch (https://models.dev/api.json)
  4. Background refresh every 60 minutes

Design philosophy:
  - Independent implementation, not copied from Hermes
  - Same API surface for 1:1 capability alignment
  - Rich dataclass wrappers for structured metadata access
"""
...
# ============================================================================
# Provider ID mapping: MimirAether ↔ models.dev
# ============================================================================
...
def _get_cache_path() -> Path:
    ...
    return get_mimiraether_home() / "models_dev_cache.json"
...
# ============================================================================
# Rich model capability metadata
# ============================================================================

def _get_provider_models(provider: str) -> Optional[Dict[str, Any]]:
    """Resolve a MimirAether provider ID to its models dict from models.dev."""
    mdev_provider_id = PROVIDER_TO_MODELS_DEV.get(provider)
    if not mdev_provider_id:
        return None
...
# Patterns that indicate non-agentic or noise models
