...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - mimiraether_home (str): The active MIMIRAETHER_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.mimiraether``.
          - platform (str): "cli", "telegram", "discord", "feishu", "cron", etc.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "mimiraether").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'mimiraether memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], mimiraether_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'mimiraether memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``mimiraether_home`` is the active MIMIRAETHER_HOME directory path.
