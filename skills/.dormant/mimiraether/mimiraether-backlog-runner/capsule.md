# [DORMANT] mimiraether-backlog-runner

**沉寂时间**: 2026-07-18T04:20:39.696563+00:00
**原始分类**: mimiraether
**描述**: 领 MIMIR_EXEC_BACKLOG 一条未勾选项执行：做完打勾、验证、回报；卡住写 ISSUES 并停。 飞书/离机指挥用。触发词：做下一条 backlog、按执行清单、backlog-runner。
...
> 调用 `skill_view("mimiraether-backlog-runner")` 即可自动唤醒。
