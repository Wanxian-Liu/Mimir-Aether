# [DORMANT] mimiraether-hermes-code-study

**沉寂时间**: 2026-07-29T08:53:25.021062+00:00
**原始分类**: mimiraether
**描述**: 系统化学习Hermes Agent源码，识别与MimirAether的差距，制定演进路线图
**触发阈值**: 60天未触碰
...
> 调用 `skill_view("mimiraether-hermes-code-study")` 即可自动唤醒。
