# [DORMANT] mimiraether-wiki-auto-archive

**沉寂时间**: 2026-07-14T18:58:40.921233+00:00
**原始分类**: mimiraether
**描述**: 当对话浮现可复用知识时自动归档到 wiki。覆盖 learnings 引用 + 追问深层原理 + 技术决策。触发权在 Agent，无需用户指令。L1 自动 / L2 询问。
**触发阈值**: 60天未触碰
...
> 调用 `skill_view("mimiraether-wiki-auto-archive")` 即可自动唤醒。
