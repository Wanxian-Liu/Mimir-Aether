---
name: mimiraether-skill-prune
description: Use when removing unused bundled skills, cleaning upstream Hermes imports, or user says skills are useless—follow git prune SOP; never blind rm. Read with mimiraether-tool-triggers.
version: 1.0.0
auto_load: false
---
...
| 技能 | 用途 |
|------|------|
| `mimiraether-skill-solidify` | 新增/修补 |
| `mimiraether-tool-triggers` | 何时想到 skill_manage / 本 prune |
| `skills-qa` | 质量/幽灵技能报告 |
| `mimiraether-auto-load` | 删后审计 auto_load 膨胀 |
