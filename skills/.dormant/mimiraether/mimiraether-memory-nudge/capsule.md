# [DORMANT] mimiraether-memory-nudge

**沉寂时间**: 2026-07-14T18:58:40.607512+00:00
**原始分类**: mimiraether
**描述**: MimirAether Memory Nudge — 记忆轻推系统。通过上下文相关记忆检索、定时刷新、记忆强度追踪和遗忘模拟，主动唤醒长期记忆。包含记忆质量评分和主动提示机制。
...
> 调用 `skill_view("mimiraether-memory-nudge")` 即可自动唤醒。
