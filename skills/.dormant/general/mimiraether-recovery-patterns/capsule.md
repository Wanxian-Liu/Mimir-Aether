# [DORMANT] mimiraether-recovery-patterns

**沉寂时间**: 2026-07-14T18:58:39.988520+00:00
**原始分类**: general
**描述**: Tool-level error recovery patterns — when file/process/network operations fail, apply standard recovery before escalation
**触发阈值**: 60天未触碰
...
> 调用 `skill_view("mimiraether-recovery-patterns")` 即可自动唤醒。
