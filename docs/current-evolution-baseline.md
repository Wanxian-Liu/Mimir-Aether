...
| **Behavioral constraints** | 3 rules | ✅ 7 rules — added JSON-read-structure-first, >3 retries→fail, SkillOpt rejection buffer, over-verification detection |
