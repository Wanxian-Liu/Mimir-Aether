...
| 层级 | 含义 | 完成度 | 说明 |
|------|------|:------:|------|
| **A. 工程底座** | 能跑、能回归、能运维（CLEARANCE 8/8 · M0–M6 · tier0 **513+2**） | **~88%** | 余：Gateway 十条零星 · TRUNCATE 历史噪声 |
| **B. IQ/SEM/Autonomy** | §15 Wave1–8 · §14 SEM · §17 AUTO · §18 Wave9 | **100%** | 本阶段已结案 |
| **C. Horizon C §19.1** | 11+4 工程粒（Wave10→15+） | **20%** | **3/15** `[x]` · **Wave 10 收口** |
...
| 项 | 计算 |
|----|------|
| 代入 | 0.25×88 + 0.15×100 + 0.25×20 + 0.05×20 + 0.25×22 + 0.05×49 |
| **综合** | **≈ 51%** |

**读法：**

- **~51%** = **Wave 10 三粒收口**（curator · tool cache 观测 · SDH system prompt）；下一程 **Wave 11**（TQM + Search）。
