...
|---|----------|-------------|-------------|-------------------|------------|
| 1 | **2026-05-05** 里程碑 **∞** 绿（工程裁定） | **§∞1 可审计周期索引** **#1–#4**；滚动 **90** 天窗口 **`2026-02-05`～`2026-05-05`（`as-of 2026-05-05`）** | **§∞2 新类任务样本** **#1**（`e21b065`，H15）+ **#2**（`2500740`，M4 HTTP） | **[`weave_charter.md`](weave_charter.md) v0.1** + **§宪章对照审查记录 #1、#2** | 本批见 [`evolution_log.md`](evolution_log.md) **末行**；裁定前 **`./run_ralph_tier0.sh` PASS** |
...
| 2026-05-05 | **里程碑 ∞ 绿**（工程裁定） | **§∞ 绿裁定记录 #1**；**∞1–∞2** 证据齐；**∞3/∞4** 宪章对照 **#1–#2**；MAINLINE **∞**→**绿** | [`MAINLINE_STATUS.md`](MAINLINE_STATUS.md) §2；[`evolution_log.md`](evolution_log.md) **末行** |
