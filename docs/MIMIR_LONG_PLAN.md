...
**依据**：[`MIMIR_CLARIFY_BASELINE.md`](./MIMIR_CLARIFY_BASELINE.md)、[`MIMIR_HTML_MEMORY_CONTRACT.md`](./MIMIR_HTML_MEMORY_CONTRACT.md)、[`MIMIR_OPENCLAW_BOUNDARY.md`](./MIMIR_OPENCLAW_BOUNDARY.md)、[`MIMIR_MIMICORE_SPRING_SCOPE.md`](./archive/mimicore/MIMIR_MIMICORE_SPRING_SCOPE.md)、[`DEVELOPMENT_NORTH_STAR.md`](./DEVELOPMENT_NORTH_STAR.md)。
