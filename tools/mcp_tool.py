...
# Import from split modules (HC-12 structural refactor)
...
# _normalize_mcp_input_schema, sanitize_mcp_name_component, _convert_mcp_schema
# moved to tools/mcp_schema.py (HC-12)
...
# _build_utility_schemas, _normalize_name_filter, _parse_boolish,
# _UTILITY_CAPABILITY_METHODS, _select_utility_schemas
# moved to tools/mcp_schema.py (HC-12)
