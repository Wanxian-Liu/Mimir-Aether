...
def _build_provider_env_blocklist() -> frozenset:
    ...
    SENSITIVE_VARS = {
        ...
        "TOGETHER_API_KEY", "AI21_API_KEY", "COHERE_API_KEY",
        "MINIMAX_API_KEY", "ZHIPU_API_KEY", "DEEPSEEK_API_KEY",
        "TWILIO_ACCOUNT_SID", "TWILIO_AUTH_TOKEN",
        "SENDGRID_API_KEY", "STRIPE_SECRET_KEY",
        "TOOL_GATEWAY_KEY", "FIREWORKS_API_KEY",
        "AZURE_OPENAI_API_KEY", "GITHUB_TOKEN",
    }
    blocked.update(SENSITIVE_VARS)

    # 自研: OPTIONAL_ENV_VARS 不再从hermes_cli获取，已在上面SENSITIVE_VARS中覆盖
