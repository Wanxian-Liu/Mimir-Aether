...
# community hub installs. Falls back gracefully if not available.
try:
...
def _find_skill(name: str) -> Optional[Dict[str, Any]]:
    ...
    try:
        ...
        from mimiraether_constants import get_mimiraether_home
        get_all_skills_dirs = lambda: [get_mimiraether_home() / "skills"]
    ...
    try:
        ...
        if replace_all:
            ...
            if old_string in content:
                ...
                match_count = 0
                match_error = f"old_string not found in file"
