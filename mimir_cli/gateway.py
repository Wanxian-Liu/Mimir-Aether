...
# when mimir_constants is cached from a pre-update version during `hermes update`.
...
def find_gateway_pids(exclude_pids: set | None = None, all_profiles: bool = False) -> list:
    ...
    patterns = [
        "mimir_cli.main gateway",
        "mimir_cli.main --profile",
        "mimir_cli.main -p",
        "mimir_cli/main.py gateway",
        "mimir_cli/main.py --profile",
        "mimir_cli/main.py -p",
        "hermes gateway",
        "gateway/run.py",
    ]
...
from mimir_constants import get_default_hermes_root, is_container, is_termux, is_wsl
...
def _profile_suffix() -> str:
    ...
    import hashlib
    import re
    # get_default_hermes_root not in mimiraether_constants, use mimir_constants
...
User={username}
Group={group_name}
ExecStart={python_path} -m mimir_cli.main{f" {profile_arg}" if profile_arg else ""} gateway run --replace
...
def _setup_whatsapp():
    ...
    from mimir_cli.main import cmd_whatsapp
    import argparse
