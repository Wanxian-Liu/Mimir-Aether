...
from mimir_cli import __version__ as VERSION, __release_date__ as RELEASE_DATE
...
def check_for_updates() -> Optional[int]:
    ...
    ``~/.mimir/.update_check``).  Returns the number of commits behind,
    or ``None`` if the check fails or isn't applicable.
    """
    hermes_home = get_hermes_home()
    repo_dir = hermes_home / "mimir-agent"
...
def format_banner_version_label() -> str:
    ...
    base = f"MimirAether v{VERSION} ({RELEASE_DATE})"
...
def build_welcome_banner(console: Console, model: str, cwd: str,
    ...
    agent_name = _skin_branding("agent_name", "MimirAether")
