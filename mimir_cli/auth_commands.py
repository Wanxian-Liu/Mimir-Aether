...
import mimir_cli.auth as auth_mod
...
def _get_custom_provider_names() -> list:
    ...
    try:
        from mimir_cli.config import get_compatible_custom_providers, load_config
...
def auth_remove_command(args) -> None:
    ...
    if removed.source.startswith("env:"):
        ...
        if env_var:
            from mimir_cli.config import remove_env_value
    ...
    # re-seeded on the next load_pool() call.
        ...
        from mimir_cli.auth import suppress_credential_source
