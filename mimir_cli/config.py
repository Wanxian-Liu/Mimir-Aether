...
from mimir_cli.default_soul import DEFAULT_SOUL_MD


# =============================================================================
# CLI runtime defaults (D7-0a · E-004)
# =============================================================================
...
def get_managed_system() -> Optional[str]:
    ...
    managed_marker = get_mimiraether_home() / ".managed"
...
def get_container_exec_info() -> Optional[dict]:
    ...
    container_mode_file = get_mimiraether_home() / ".container-mode"
...
# Re-export from mimir_constants — canonical definition lives there.
from mimiraether_constants import get_mimiraether_home  # noqa: F811,E402

# Alias for backwards compatibility
get_hermes_home = get_mimiraether_home
...
def get_env_path() -> Path:
    ...
    return get_mimiraether_home() / ".env"
...
DEFAULT_CONFIG = {
    ...
    "memory": {
        ...
        "memory_char_limit": 55000,  # ~20000 tokens at 2.75 chars/token
